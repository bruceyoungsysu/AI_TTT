...
class TTT3_Node:
    ...
    def score(self, depth, token, cor, alpha, beta):
        ...
        if (not self.check_finish()) and depth <= 3:
            min_score = float('inf')
            max_score = float('-inf')
...
if __name__ == '__main__':
    ttt = TTT3_Node()
    """
    ttt.state = [[{'X': [], 'O': [], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(2, 2)], 'O': [(0, 0)], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1)]},
                  {'X': [], 'O': [(0, 0)], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]}],
                 [{'X': [], 'O': [(0, 0)], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(2, 2), (2, 1)], 'O': [(1, 0), (1, 1)], 'P': [(0, 0),  (0, 2), (0, 1), (1, 2), (2, 0)]},
                  {'X': [], 'O': [(0, 0)], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]}],
                 [{'X': [(2, 2)], 'O': [(0, 0)], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1)]},
                  {'X': [], 'O': [(2, 0)], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 1), (2, 2)]},
                  {'X': [], 'O': [(0, 1), (1, 1)], 'P': [(0, 0), (0, 2), (1, 0), (1, 2), (2, 0), (2, 1), (2, 2)]}]]
    """
    ttt.state = [[{'X': [], 'O': [(1, 1), (2, 1)], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 2)]},
                  {'X': [(0, 0)], 'O': [], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(2, 2)], 'O': [], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1)]}],
                 [{'X': [], 'O': [(1, 1)], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(2, 2)], 'O': [], 'P': [(0, 0),(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1)]},
                  {'X': [], 'O': [], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]}],
                 [{'X': [], 'O': [], 'P': [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(0, 0)], 'O': [], 'P': [(0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [], 'O': [(0, 1), (0, 2)], 'P': [(0, 0), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]}]]

    a = float('-inf')
    b = float('inf')
    #print('sss'+str(ttt.score(0,'X',(1,1), a, b)))
    print(ttt.move((1,1)))
