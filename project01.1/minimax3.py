...
# minimax for the 3rd quest

import copy
from board import TTT_Board
from util import score2,score3, fullbd_score
...
class TTT3_Node:
    ...
    def __init__(self):
        ...
        self.depth = 0
        self.token = 'X'
        self.anothertoken = 'O' if self.token == 'X' else 'X'
        self.len = 3
    ...
    def score(self, depth, token, cor, alpha, beta):
        ...
        if (self.check_finish2() != 0) and depth <= 3:
            min_score = float('inf')
            max_score = float('-inf')
            ...
            bb = float('inf')
            total_score = 0
            all_scores = [[0 for i in range(3)] for j in range(3)]
            for inde in self.index:  # check whether it is the board playing
                ...
                all_scores[inde[0]][inde[1]] = s
            total_score = fullbd_score(all_scores)
            return total_score
...
if __name__ == '__main__':
    ...
    ttt.state = [[{'X': [], 'O': [], 'P': [(1, 1), (2, 1),(0, 0), (0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 2)]},
                 ...
                 [{'X': [], 'O': [], 'P': [(1, 1), (0, 0), (0, 1), (0, 2), (1, 0), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  ...
                  {'X': [(0, 0), (0, 1), (0, 2)], 'O': [], 'P': [(1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]}],
                 [{'X': [(0, 1), (0, 2)], 'O': [], 'P': [(0, 0),(1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(0, 0), (0, 1), (0, 2)], 'O': [], 'P': [(1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]},
                  {'X': [(0, 1), (0, 2), (0, 0)], 'O': [], 'P': [(1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]}]]

    a = float('-inf')
    b = float('inf')
    print('sss'+str(ttt.score(0,'X',(0,0), a, b)))

    ttt.find_chdrn('X',(2,2))
    #for t in ttt.children:
    #    print(t.state)
    #print(ttt.score('X'))
